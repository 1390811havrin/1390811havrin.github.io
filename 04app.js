...
app.get("/students", function(req, res){
	...
	//there is a send function that sends some html,
	//sets the content type, and sets the response body
	res.send("<html><body><h1>All Students</h1></body></html>");
...
app.get("/honorroll", function(req, res){
	...
	//return some html for honor roll students
	res.send("<html><body><h1>Honor Roll Students</h1></body></html>");
});

//define a route to handle all get requests to /professors/profId
app.get("/professors/:profId", function(req, res){
	
	//you have access to any part of the url that starts with : like :profId
	res.send("<html><body><h1>Professor id: " + req.params.profId + "</h1></body></html>");
});
